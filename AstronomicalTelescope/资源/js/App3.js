...
//var HOST="http://192.168.31.218:8080";
var HOST="";
...
function SendCommand(cmd, params, sync){
	...
	if(params!=undefined && params.type!=undefined && params.type=="main"){
...
function GetLocalGPS(){
	var res={
		longitude:"E 124°45′6.78″",
		latitude:"N 46°6′7.89″",
		datetime:"2019-05-28 09:10:11"
	};
